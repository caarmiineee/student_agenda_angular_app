package com.nanosoft.student_agenda.jwt;
...
public class JwtUtils {
	...
	@Value("${carmine.app.jwtSecret}")
	private String jwtSecret;
	@Value("${carmine.app.jwtExpirationMs}")
	private int jwtExpirationMs;
	@Value("${carmine.app.jwtCookieName}")
	 ...
	 * private static final Logger logger = LoggerFactory.getLogger(JwtUtils.class);
	 * 
	 * @Value("${carmine.app.jwtSecret}") private String jwtSecret;
	 * 
	 * @Value("${carmine.app.jwtExpirationMs}") private int jwtExpirationMs;
	 * 
	 ...
	 * logger.error("JWT claims string is empty: {}", e.getMessage()); } return
	 * false; }
	 */
}
